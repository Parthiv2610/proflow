    ...
    <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-border bg-background/80 px-6 py-3 backdrop-blur-md">
      ...
      >
        ...
        <input
          ...
          className="h-10 w-full rounded-xl border border-input bg-secondary/50 pl-9 pr-24 text-sm outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40"
        />
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        >
          ...
          <span className="text-focus/80">Focus</span>
        </button>
        ...
        <span className="flex size-9 items-center justify-center rounded-xl border border-border bg-secondary/50 text-primary">
